...
# --------------------------------------------------------------------------------
# This script is building packages for Alignak-Backend-Client thanks to the fpm
...
pkg_name="${python_prefix}-alignak-backend-client"
pkg_description="Alignak backend client, python client for Alignak Backend"
